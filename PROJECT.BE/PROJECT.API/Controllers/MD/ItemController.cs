...
namespace PROJECT.API.Controllers.MD
{
    ...
    public class ItemController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblItemDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblItemDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblItemDto unit)
        {
            var transferObject = new TransferObject();
