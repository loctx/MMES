...
namespace PROJECT.API.Controllers.MD
{
    ...
    {
        public readonly ISandService _service;
        public SandController(ISandService service)
        {
            _service = service;
        }
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblSandDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblSandDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblSandDto unit)
        {
            var transferObject = new TransferObject();
