...
namespace PROJECT.API.Controllers.MD
{
    ...
    public class VehicleController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblVehicleDto vehicle)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblVehicleDto vehicle)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblVehicleDto vehicle)
        {
            var transferObject = new TransferObject();
            await _service.Delete(vehicle);
            if (_service.Status)
            {
                transferObject.Status = true;
                transferObject.MessageObject.MessageType = MessageType.Success;
