...
namespace PROJECT.API.Controllers.MD
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblDepartmentDto department)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblDepartmentDto department)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblDepartmentDto department)
        {
            var transferObject = new TransferObject();
