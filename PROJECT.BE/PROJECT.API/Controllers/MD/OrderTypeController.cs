...
namespace PROJECT.API.Controllers.MD
{
    ...
    {
        public readonly IOrderTypeService _service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblOrderTypeDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblOrderTypeDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblOrderTypeDto unit)
        {
            var transferObject = new TransferObject();
