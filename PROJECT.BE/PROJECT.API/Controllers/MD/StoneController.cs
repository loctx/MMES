...
namespace PROJECT.API.Controllers.MD
{
    ...
    {
        public readonly IStoneService _service;
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblStoneDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblStoneDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblStoneDto unit)
        {
            var transferObject = new TransferObject();
