...
namespace PROJECT.API.Controllers.MD
{
    ...
    [ApiController]
    public class PourTypeController : ControllerBase
    {
        public readonly IPourTypeService _service;
        public PourTypeController(IPourTypeService service)
        {
            _service = service;
        }
        ...
        [HttpPost("Insert")]
        public async Task<IActionResult> Insert([FromBody] tblPourTypeDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpPut("Update")]
        public async Task<IActionResult> Update([FromBody] tblPourTypeDto unit)
        {
            var transferObject = new TransferObject();
        ...
        [HttpDelete("Delete")]
        public async Task<IActionResult> Delete([FromBody] tblPourTypeDto unit)
        {
            var transferObject = new TransferObject();
