...
namespace PROJECT.CORE.Dtos.SO
{
    public class tblStoreOrderOperatingDto : IMapFrom
    {
        ...
        public decimal? RealRequireNumber { get; set; }
        ...
        {
            profile.CreateMap<tblStoreOrderOperating, tblStoreOrderOperatingDto>().ReverseMap();
        }
    }
}
